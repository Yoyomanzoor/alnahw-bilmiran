...
\begin{english}
    \boldred{\textarabic{المُركَّب التَوصِيفِي}}\index{مركب غير مفيدة!التوصيفي} are descriptive phrases. It consists of the \textarabic{مَوصُوف} (thing being described) and \textarabic{صِفَة} (descriptor). The rules can be remembered by the \textarabic{صفة} and \textarabic{موصوف} matching in \textbf{DING}:
    \begin{itemize}
