...
\begin{english}
    \boldred{\textarabic{الجملة الاسمية}}\index{الجمل!الاسمية} is another simple sentence form in Arabic. It begins with an \textarabic{اسم} and consists of a \textarabic{مُبتَدَأ} (subject) and a \textarabic{خَبَر} (predicate). Both are in the \textarabic{حال} of \textarabic{مرفوع}.
