...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	\textit{\textenglish{Darussalam Seminary\\\vspace{3mm}The University of Michigan}} % Editor affiliation
...
\noindent{\textenglish{\textcopyright   Sumeed Manzoor all rights reserved.\\No reproduction, distribution, or derivation without explicit permission.\\Inshaallah, I will release rights once the first draft is completed.}}
...
\printbibliography[keyword={english},heading=subbibliography,title={\textenglish{English sources}\hfill}]
